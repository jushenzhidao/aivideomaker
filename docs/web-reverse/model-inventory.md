...
> ② **「480p 最长 8 秒」不成立** —— 但 480p **也不是连续区间**（2026-09-24 二次更正）：
>    站点对 480p 只收**离散档位 `5 / 10 / 15 / 20`**（`480p supports 5s, 10s, 15s, or
>    20s duration.`，E2E-AVM-016 + 生产 38 次 502 实锤）；`translate.DURATION_ALLOWED`
>    已改离散表 ⇒ 免费档为 **5 与 10**。720p / 1080p 仍为连续区间（1080p 离散与否未测）。
